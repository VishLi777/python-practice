# Реализуйте свою структуру данных, хэш-таблицу, аналог встроенного dict. Используйте функцию hash.
# Примените тестирование на случайных данных.
...
# 3. Реализуйте поддержку для цикла for. :return:
