...
def test_circ_buffer():
    #     tests = 0 для затруднения покрытия
    #     buffer_size = 100
    #
    tests = 1000
    buffer_size = 100
...
# Команды для запуска
# pytest coverage/coverage.py --cov=. --cov-branch
# pytest coverage/coverage.py --cov=. --cov-branch --cov-report=html
